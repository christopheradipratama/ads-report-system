                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store-report') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="identity_type"
                                        class="form-select @error('identity_type') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="identity_number" type="text"
                                        ...
                                        autocomplete="identity_number" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="pob" type="text"
                                        ...
                                        value="{{ old('pob') }}" required autocomplete="pob" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="image"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Report Evidence') }}</label>
                                <div class="col-md-6">
